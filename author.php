        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                   <?php
                   $sql2="SELECT * FROM user WHERE user_id={$aut_id} ";
...
?>
                    ...
                    $sql1="SELECT * FROM post WHERE author={$aut_id} ";
                  ...
                  <ul class='pagination admin-pagination'>
                    ...
                    {
                     ?>
                       <li class="active"><a href="author.php?aid=<?php echo $aut_id ;?>&page=<?php echo ($page-1); ?>">pre</a></li>
                    ...
                    <?php
                     ...
                     <li class="<?php echo $active ?>"><a href="author.php?aid=<?php echo $aut_id; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                     ...
                     {
                      ?>
                      <li class="active"><a href="author.php?aid=<?php echo $aut_id; ?>&page=<?php echo ($page+1); ?>">next</a></li>
                      <?php
                     }
                     ?>
                  </ul>
